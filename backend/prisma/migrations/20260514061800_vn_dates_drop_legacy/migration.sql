...
INSERT INTO "new_Person" ("biography", "birthDateLunar", "birthDay", "birthMonth", "birthYear", "branchId", "burialPlace", "createdAt", "deathDateLunar", "deathDay", "deathMonth", "deathYear", "fatherId", "fullName", "gender", "generation", "honorific", "id", "motherId", "nameNormalized", "notes", "occupation", "updatedAt") SELECT "biography", "birthDateLunar", "birthDay", "birthMonth", "birthYear", "branchId", "burialPlace", "createdAt", "deathDateLunar", "deathDay", "deathMonth", "deathYear", "fatherId", "fullName", "gender", "generation", "honorific", "id", "motherId", "nameNormalized", "notes", "occupation", "updatedAt" FROM "Person";
DROP TABLE "Person";
